...
export default defineConfig({
  ...
  include: /^(MockUSDC|MockERC7984ERC20Wrapper|MockConfidentialToken|Mock1271Wallet|ContinuousStealthWrapAdapter|BatchedStealthWrapAdapter|RecurringAllowance)$/,
  plugins: [],
});
